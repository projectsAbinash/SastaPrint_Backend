            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img src="{{ url('AdminAssets/Source/assets/img/pngwing.com.png') }}" alt="user-avatar" class="d-block rounded"
                            height="100" width="100" id="imgPreview" />
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" type="text" value="{{ old('name') }}"
                                    id="firstName" name="name" autofocus  />
                            </div>

                            <div class="mb-3 col-md-6">
                                <label for="Phone" class="form-label">Phone Number</label>
                                <input class="form-control @error('phone') is-invalid @enderror" type="number" value="{{ old('phone') }}"
                                    id="Phone" name="phone" autofocus  />
                            </div>

                            <div class="mb-3 col-md-6">
                                <label for="Aadhar" class="form-label">Aadhar Number</label>
                                <input class="form-control @error('aadhar') is-invalid @enderror" type="text" value="{{ old('aadhar') }}"
                                    id="iban" name="aadhar" autofocus  />
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control dropify" type="file"
                                    id="fside" name="faadhar" autofocus  />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="bside" class="form-label">Aadhar Back Side</label>
                                <input class="form-control dropify" type="file"
                                    id="bside" name="baadhar" autofocus  />
                            </div>

                        </div>
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2">Register</button>
                            <a href="{{ route('DashboardIndex') }}"><button type="button" class="btn btn-outline-secondary">Cancel</button></a>
                        </div>
                    </form>
                </div>
                <!-- /Account -->
